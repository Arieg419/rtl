...
function SearchItem(item, navigation) {
    return (React.createElement(react_native_1.TouchableOpacity, { onPress: function () {
...
exports.SearchItemSeperator = SearchItemSeperator;
